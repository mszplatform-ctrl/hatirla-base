// App.tsx — XOTIJI MINIMAL BRANDING APPLIED
...
export default function App() {
  ...
  const [selectedExperienceIds, setSelectedExperienceIds] =
    useState<number[]>([]);
          ...
          {loadingDetails ? (
            ...
            <>
              ...
              >
                ...
                >
                  {composeLoading
                    ? "AI paket oluşturuyor..."
                    : "📦 AI ile paket oluştur"}
                </button>
              </div>
            </>
          )}
